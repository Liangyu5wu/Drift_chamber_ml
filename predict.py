...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, default='source_test.root')
    parser.add_argument('--input_tree', type=str, default='sim')
    parser.add_argument('--output_file', type=str, default='results/pred.root')
    parser.add_argument('--wf_sign', type=int, default=1)
    parser.add_argument('--model_file', type=str, default='dnn.pth')
    parser.add_argument('--event_range', type=lambda x:ast.literal_eval(x), default='(0, 100)')
